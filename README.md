...
SPA en React 18 + Vite + CSS Modules, servida como estático (nginx vía el
`dockerfile` en la raíz del workspace).
...
- **Seguridad**: headers (CSP, nosniff, X-Frame-Options) en `nginx.conf`.
