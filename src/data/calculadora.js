...
export const RANGE_ROWS = [
  { range: '0.8 g/kg',       label: 'RDA oficial',                   min: 0.8,  max: 0.8  },
  { range: '1.2 – 1.6 g/kg', label: 'Salud general y mantenimiento', min: 1.2,  max: 1.6  },
  { range: 'mín. 1.2 g/kg',  label: 'Adultos mayores',               min: 1.2,  max: 1.2  },
  { range: '1.6 g/kg',       label: 'Entrenamiento de resistencia',   min: 1.6,  max: 1.6  },
  { range: '> 1.6 g/kg',     label: 'Recomposición corporal',         min: 1.61, max: 1.99 },
  { range: 'hasta 2.2 g/kg', label: 'Atletas de alto rendimiento',    min: 2.0,  max: 2.2  },
];
